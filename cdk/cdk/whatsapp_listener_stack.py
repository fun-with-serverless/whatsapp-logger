    ...
    def __init__(
        ...
        **kwargs,
        ...
        sg = ec2.SecurityGroup(
            self, "HTTPSOnly", vpc=cluster.vpc, allow_all_outbound=False
        )
        ...
        whatsapp_listener_container = fargate_task_definition.add_container(
            ...
            environment={
                "QR_BUCKET_NAME": self._bucket.bucket_name,
        ...
        fargate_task_definition.add_to_task_role_policy(
            iam.PolicyStatement(
                actions=["s3:PutObject"], resources=[f"{self._bucket.bucket_arn}/*"]
            )
        )
        ...
        CfnOutput(self, "QRBucket", value=self._bucket.bucket_name)
